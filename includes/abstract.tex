...
V rámci práce boli navrhnuté tri architektúry konvolučných neurónových sietí s rôznou zložitosťou.
 Pre každú architektúru boli systematicky testované rôzne rozmery vstupných obrázkov spolu s kombináciami hyperparametrov, 
 ako sú rýchlosť učenia, veľkosť spracovanej dávky (batchu), dropout a počet neurónov v plne prepojenej vrstve.
...
odmocniny zo strednej kvadratickej chyby (\acrshort{rmse}). Súčasne bol analyzovaný čas trénovania a počet potrebných epoch, čím sa 
